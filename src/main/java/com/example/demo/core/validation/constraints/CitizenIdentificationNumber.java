...
import com.example.demo.core.validation.validators.CitizenIdentificationNumberValidator;
...
public @interface CitizenIdentificationNumber {
	...
	String message() default "{com.example.demo.core.validation.constraints.CitizenIdentificationNumber.message}";
